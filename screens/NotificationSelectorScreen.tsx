...
const NotificationSelectorScreen: React.FC = () => {
  ...
  const handlePreview = (sound: SoundOption, e: React.MouseEvent) => {
    e.stopPropagation();
                    ...
                    {option.type === 'audio' && (
                      <button
                        ...
                        className={`p-2 rounded-full transition-colors ${
                          isPlaying 
                            ? 'text-santri-green bg-green-100 dark:bg-green-900/40' 
                            : 'text-slate-400 hover:text-santri-green hover:bg-slate-100 dark:hover:bg-slate-700'
                        }`}
                      >
