...
class WebAppInterface(
    ...
    fun setAdhanAudio(prayerName: String, url: String, coverUrl: String?) {
        val key = prayerName.lowercase().trim()
        prayerAdhanAudios[key] = url
        // Unduh dan simpan file MP3 adzan ke direktori offline lokal Android
        AdzanAudioStorageManager.downloadAndSaveAudioAsync(activity.applicationContext, key, url)
    }
